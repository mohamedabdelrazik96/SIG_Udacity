...
import com.sig.controller.InvoiceSalesActionListener;
...
public class InvoiceSalesFrame extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InvoiceSalesFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InvoiceSalesFrame().setVisible(true);
            }
        });
    }
    ...
    public void setLinesArray(ArrayList<InvoicSaleseLine> linesArray) {
        this.linesArray = linesArray;
    }
    
    public void setInvoicesArray(ArrayList<InvoiceSalesHeaderSales> invoicesArray) {
        this.invoicesArray = invoicesArray;
    }

    public ArrayList<InvoiceSalesHeaderSales> getInvoicesArray() {
        return invoicesArray;
    }
    
    public InvoiceSalesHeaderSales getInvObject(int code) {
        for (InvoiceSalesHeaderSales inv : invoicesArray) {
            if (inv.getNum() == code) {
                return inv;
            }
        }
    ...
    public InvoiceSalesHeaderTableModel getHeaderTableModel() {
        return headerTableModel;
    }

    public void setHeaderTableModel(InvoiceSalesHeaderTableModel headerTableModel) {
    ...
    public InvoiceSalesActionListener getActionListener() {
